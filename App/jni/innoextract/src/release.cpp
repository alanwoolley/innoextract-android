...
const char innoextract_version[] = "1.4";

const char innosetup_versions[] = "Inno Setup 1.2.10 to 5.5.3";

const char innoextract_copyright[] = "(C) 2011-2013 Daniel Scharrer <daniel@constexpr.org>";
